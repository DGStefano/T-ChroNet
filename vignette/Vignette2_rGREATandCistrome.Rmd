...
source("/mnt/nas-safu01/analysis/scripts/ScriptSdigiove/RegNetATACProject/T-ChroNet/utils/R_utils.R")
```

```{r}
list_files_communities = list.files(path = "/mnt/nas-safu01/analysis/scripts/ScriptSdigiove/RegNetATACProject/T-ChroNet/vignette/results/bed/" , full.names = TRUE)
...
```{r}
folders_to_compare = list.files('/mnt/nas-safu01/analysis/scripts/ScriptSdigiove/RegNetATACProject/T-ChroNet/vignette/results/cistromdb_thp1/')

for (community in folders_to_compare){ 
    to_read = paste('/mnt/nas-safu01/analysis/scripts/ScriptSdigiove/RegNetATACProject/T-ChroNet/vignette/results/cistromdb_thp1/' ,community , sep = "")
...
tfs_name = read_delim("/mnt/nas-safu01/analysis/scripts/ScriptSdigiove/RegNetATACProject/T-ChroNet/vignette/data/TF_names_v_1.01.txt" , delim = "\t" , col_names = F)
tfs_name <- tfs_name %>%
