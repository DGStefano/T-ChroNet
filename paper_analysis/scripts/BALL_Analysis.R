...
series_ball <- build_TChroNetSeries_object("~/T-ChroNet/paper_analysis/data/BCP-ALL/th",matrix_path,method = "Leiden",resolutions_list = seq(0.5, 1.5, 0.1),run_cd = T,seed = 123, transitivity = FALSE)


pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/rand_index_map.pdf"  ,
  height = 9, 
  width = 5,
  family = "ArialMT",
  useDingbats = FALSE)
...
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/relative_lcc.pdf"  ,
  height = 5, 
  width = 9,
  family = "ArialMT",
  useDingbats = FALSE)
...
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/community_sankey_th_05.pdf"  ,
  height = 5, 
  width = 9,
  family = "ArialMT",
  useDingbats = FALSE)
...
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/modularity.pdf"  ,
  height = 5, 
  width = 9,
  family = "ArialMT",
  useDingbats = FALSE)
...
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/community_size.pdf"  ,
  height = 5, 
  width = 9,
  family = "ArialMT",
  useDingbats = FALSE)
...
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/sankey_plot_best_res.pdf"  ,
  height = 5, 
  width = 9,
  family = "ArialMT",
  useDingbats = FALSE)
...
ball_obj <- annotate_regions_from_bed(ball_obj , bed_path = "~/T-ChroNet/toy_data/data/GRCh38-cCREs.bed" , genome = 'hg38')
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/stacked.pdf"  ,
  height = 5, 
  width = 9,
  family = "ArialMT",
  useDingbats = FALSE)
...
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/boxplot_trends.pdf"  ,
  height = 10, 
  width = 7,
  family = "ArialMT",
  useDingbats = FALSE)
...
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/lineplot_trends.pdf"  ,
  height = 10, 
  width = 7,
  family = "ArialMT",
  useDingbats = FALSE)
...
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/violin_trends.pdf"  ,
  height = 10, 
  width = 7,
  family = "ArialMT",
  useDingbats = FALSE)
...
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/Metaprograms.pdf"  ,
  height = 5, 
  width = 9,
  family = "ArialMT",
  useDingbats = FALSE)
...
for (x in seq_along(list_communities_11)) {
  ...
  out_file <- paste("~/T-ChroNet/paper_analysis/data/BCP-ALL/beds/community_hg38_" , as.character(x) , ".bed" , sep ="")
  write_delim(comm_hg38 , out_file , delim ="\t" , col_names = F)
}

pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/TFs.pdf"  ,
  height = 8, 
  width = 7,
  family = "ArialMT",
  useDingbats = FALSE)
plot_cistrome("~/T-ChroNet/paper_analysis/data/BCP-ALL/cistrome" , tf_name_file = "~/T-ChroNet/paper_analysis/TFs_screening/TF_names_v_1.01.txt" )+
  theme(text = element_text(size = 15))+
  theme(legend.position="top" , legend.text = element_text(size=15))
dev.off()


pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/Heatmap.pdf"  ,
  height = 9, 
  width = 5,
  family = "ArialMT",
  useDingbats = FALSE)
...
communities_paper <- list.files("~/T-ChroNet/paper_analysis/data/BCP-ALL/communities/" , full.names = T)
...
pdf("~/T-ChroNet/paper_analysis/data/BCP-ALL/overlaps_communities_with_olds.pdf"  ,
  height = 6, 
  width = 6,
  family = "ArialMT",
  useDingbats = FALSE)
